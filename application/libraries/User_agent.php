...
class CI_User_agent {
	...
	function _compile_data()
	{
		...
		foreach (array('_set_browser', '_set_robot', '_set_mobile', '_set_provider') as $function)
		{
	 ...
	 * @return	bool
	 */
	function _set_provider()
	{
		if (is_array($this->providers) AND count($this->providers) > 0)
		{
...
//				if (preg_match("|".preg_quote($key)."|i", $this->agent))
		...
		$this->provider = 'Unknown Platform';
	}
